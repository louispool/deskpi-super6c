#!/bin/bash
# Displays the throttling status of a Raspberry Pi. Assumes `vcgencmd` has been installed.
#
# Shamelessly copied from https://github.com/ricsanfre/pi-cluster/blob/master/ansible/roles/basic_setup/scripts/pi_throttling
